...
public struct ListRolesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListRolesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRolesResponse().with { $0.roles = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.iam.admin.v1.ListRolesResponse"
  }
...
extension ListRolesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Role] {
    return self.roles
  }
