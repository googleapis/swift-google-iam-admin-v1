...
public struct DeleteRoleRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteRoleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteRoleRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.iam.admin.v1.DeleteRoleRequest"
  }
