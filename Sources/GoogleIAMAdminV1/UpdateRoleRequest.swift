...
public struct UpdateRoleRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateRoleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateRoleRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.iam.admin.v1.UpdateRoleRequest"
  }
