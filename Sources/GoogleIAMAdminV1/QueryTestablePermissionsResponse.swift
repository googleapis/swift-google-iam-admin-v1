...
public struct QueryTestablePermissionsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `QueryTestablePermissionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = QueryTestablePermissionsResponse().with { $0.permissions = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Permission].self, forKey: .permissions) {
