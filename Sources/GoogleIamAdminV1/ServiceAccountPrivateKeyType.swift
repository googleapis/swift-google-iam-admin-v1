...
public enum ServiceAccountPrivateKeyType: Codable, Equatable, Sendable {
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ServiceAccountPrivateKeyType/unknownStringValue(_:)).
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ServiceAccountPrivateKeyType/unknownIntValue(_:)).
